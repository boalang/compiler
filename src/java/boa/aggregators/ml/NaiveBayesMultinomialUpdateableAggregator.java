...
/**
 * A Boa aggregator for training the model using NaiveBayesMultinomialUpdateable.
 * 
 * @author ankuraga
 */
@AggregatorSpec(name = "naivebayesmultinomialupdateable", formalParameters = {"string"})
public class NaiveBayesMultinomialUpdateableAggregator extends MLAggregator {
	private ArrayList<String> vector = new ArrayList<String>();
	private ArrayList<BoaTup> tuples = new ArrayList<BoaTup>();
	private String[] options;
	private int count = 0;
	private NaiveBayesMultinomialUpdateable model;
	...
	public NaiveBayesMultinomialUpdateableAggregator(final String s) {
		super(s);
	...
	public void attributeCreation(BoaTup data) {
		...
		try {
			...
			this.flag = true;
			this.trainingSet = new Instances("NaiveBayesMultinomialUpdateable", this.fvAttributes, 1);
