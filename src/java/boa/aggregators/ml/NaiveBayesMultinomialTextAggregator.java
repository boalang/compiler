...
/**
 * A Boa aggregator for training the model using NaiveBayesMultinomialText.
 * 
 * @author ankuraga
 */
@AggregatorSpec(name = "naivebayesmultinomialtext", formalParameters = {"string"})
public class NaiveBayesMultinomialTextAggregator extends MLAggregator {
	...
	public NaiveBayesMultinomialTextAggregator() {
	}

	public NaiveBayesMultinomialTextAggregator(final String s) {
		super(s);
	...
	public void finish() throws IOException, InterruptedException {
		try {
			this.model = new NaiveBayesMultinomialText();
	...
	public void attributeCreation(BoaTup data) {
		...
		try {
			...
			this.flag = true;
			this.trainingSet = new Instances("NaiveBayesMultinomialText", this.fvAttributes, 1);
