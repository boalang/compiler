 ...
 * @author ankuraga
 */
@AggregatorSpec(name = "ibk", formalParameters = {"string"})
public class IBkAggregator extends MLAggregator {
    private int count = 0;
    private IBk model;

    public IBkAggregator() {
    }

    public IBkAggregator(final String s) {
        super(s);
    }

    @Override
    public void aggregate(String data, String metadata) throws NumberFormatException, IOException, InterruptedException {
        aggregate(data, metadata, "IBK");
    }
    ...
    public void finish() throws IOException, InterruptedException {
        ...
        System.out.println("ibk modeling done");
