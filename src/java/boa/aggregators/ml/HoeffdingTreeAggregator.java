...
/**
 * A Boa aggregator for training the model using HoeffdingTree.
 * 
 * @author ankuraga
 */
@AggregatorSpec(name = "hoeffdingtree", formalParameters = {"string"})
public class HoeffdingTreeAggregator extends MLAggregator {
	...
	public HoeffdingTreeAggregator() {
	}

	public HoeffdingTreeAggregator(final String s) {
		super(s);
	...
	public void attributeCreation(BoaTup data) {
		...
		try {
			...
			this.flag = true;
			this.trainingSet = new Instances("HoeffdingTree", this.fvAttributes, 1);
