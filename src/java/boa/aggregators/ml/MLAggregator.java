...
//			filePath = new Path("/boa/data", new Path("" + boaJobId, new Path(("" + getKey()).split("\\[")[0] + System.currentTimeMillis() + "data")));
			filePath = new Path(DefaultProperties.HADOOP_SEQ_FILE_LOCATION + "/boa/data/data");
	...
	public void saveModel(Object model) {
		...
		try {
			...
			filePath = new Path(DefaultProperties.HADOOP_SEQ_FILE_LOCATION + "/boa/models/ML.model");
//			filePath = new Path("/Users/nmtiwari/Desktop/ML.model");
