...
/**
 * A shadow type for SynchronizedStatement.
 * 
 * @author rdyer
 * @author kaushin
 */
public class SynchronizedStatementShadow extends BoaShadowType  {
    /**
    ...
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "SYNCHRONIZED", new StatementKindProtoMap(), env);
    }
