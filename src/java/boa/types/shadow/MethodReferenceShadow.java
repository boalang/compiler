 ...
 * @author kaushin
 */
public class MethodReferenceShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link MethodReferenceShadow}.
     */
    public MethodReferenceShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type MethodReferenceShadow");
    }
    ...
    public IfStatement getManytoOne(final SymbolTable env, final Block b) {
        return getManytoOne(env, b, "ismethodref", new boa.types.proto.ExpressionProtoTuple());
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.MethodReference m) {
