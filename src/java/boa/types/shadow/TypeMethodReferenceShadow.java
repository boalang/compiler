 ...
 * @author kaushin
 */
public class TypeMethodReferenceShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link TypeMethodReferenceShadow}.
     */
    public TypeMethodReferenceShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type TypeMethodReferenceShadow");
    }
    ...
    public IfStatement getManytoOne(final SymbolTable env, final Block b) {
        return getManytoOne(env, b, "istyperef", new boa.types.proto.ExpressionProtoTuple());
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.MethodReference.TypeMethodReference m) {
