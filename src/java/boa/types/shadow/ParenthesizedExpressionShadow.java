 ...
 * @author kaushin
 */
public class ParenthesizedExpressionShadow extends boa.types.BoaShadowType  {
    /**
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type ParenthesizedExpressionShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("ExpressionKind", "PAREN", new boa.types.proto.enums.ExpressionKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.ParenthesizedExpression m) {
