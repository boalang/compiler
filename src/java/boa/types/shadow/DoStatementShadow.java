...
/**
 * A shadow type for DoStatement.
 * 
 * @author rdyer
 * @author kaushin
 */
public class DoStatementShadow extends BoaShadowType  {
    /**
    ...
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "DO", new StatementKindProtoMap(), env);
    }
