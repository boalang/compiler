...
/**
 * A shadow type for Javadoc.
 * 
 * @author rdyer
 * @author kaushin
 */
public class JavadocShadow extends BoaShadowType  {
    /**
     * Construct a {@link JavadocShadow}.
     */
    public JavadocShadow() {
    ...
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("CommentKind", "DOC", new CommentKindProtoMap(), env);
    }
