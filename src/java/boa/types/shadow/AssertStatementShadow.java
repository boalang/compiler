 ...
 * @author kaushin
 */
public class AssertStatementShadow extends boa.types.BoaShadowType  {
    /**
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        if ("expression".equals(name)) return ASTFactory.createSelector("expression_2", new boa.types.proto.ExpressionProtoTuple(), env);

        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type AssertStatementShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "ASSERT", new boa.types.proto.enums.StatementKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Statement flattenMessage(final boa.types.Ast.Statement.AssertStatement m) {
        ...
        if (m.hasExpression()) b.setExpression2(m.getExpression());
        return b.build();
    }
