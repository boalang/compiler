...
/**
 * A shadow type for InstanceofExpression.
 * 
 * @author rdyer
 * @author kaushin
 */
public class InstanceofExpressionShadow extends BoaShadowType  {
    /**
    ...
    public InstanceofExpressionShadow() {
        ...
        addShadow("right_operand", new TypeProtoTuple());
    ...
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("ExpressionKind", "TYPECOMPARE", new ExpressionKindProtoMap(), env);
    }
