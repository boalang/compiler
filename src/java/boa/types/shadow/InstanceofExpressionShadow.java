 ...
 * @author kaushin
 */
public class InstanceofExpressionShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link InstanceofExpressionShadow}.
     */
    public InstanceofExpressionShadow() {
        super(new boa.types.proto.ExpressionProtoTuple());

        addShadow("left_operand", new boa.types.proto.ExpressionProtoTuple());
        addShadow("right_operand", new boa.types.proto.TypeProtoTuple());
    }
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        if ("right_operand".equals(name)) return ASTFactory.createSelector("type_1", new boa.types.proto.TypeProtoTuple(), env);

        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type InstanceofExpressionShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("ExpressionKind", "TYPECOMPARE", new boa.types.proto.enums.ExpressionKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.InstanceofExpression m) {
