 ...
 * @author kaushin
 */
public class BreakStatementShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link BreakStatementShadow}.
     */
    public BreakStatementShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type BreakStatementShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "BREAK", new boa.types.proto.enums.StatementKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Statement flattenMessage(final boa.types.Ast.Statement.BreakStatement m) {
