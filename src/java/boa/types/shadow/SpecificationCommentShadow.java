 ...
 * @author kaushin
 */
public class SpecificationCommentShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link SpecificationCommentShadow}.
     */
    public SpecificationCommentShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type SpecificationCommentShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("CommentKind", "SPEC", new boa.types.proto.enums.CommentKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Comment flattenMessage(final boa.types.Ast.Comment.SpecificationComment m) {
        final boa.types.Ast.Comment.Builder b = boa.types.Ast.Comment.newBuilder();
        b.setKind(boa.types.Ast.Comment.CommentKind.SPEC);
