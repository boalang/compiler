 ...
 * @author kaushin
 */
public class ExpressionMethodReferenceShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link ExpressionMethodReferenceShadow}.
     */
    public ExpressionMethodReferenceShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type ExpressionMethodReferenceShadow");
    }
    ...
    public IfStatement getManytoOne(final SymbolTable env, final Block b) {
        return getManytoOne(env, b, "isexpref", new boa.types.proto.ExpressionProtoTuple());
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.MethodReference.ExpressionMethodReference m) {
