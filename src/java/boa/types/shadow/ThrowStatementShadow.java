...
/**
 * A shadow type for ThrowStatement.
 * 
 * @author rdyer
 * @author kaushin
 */
public class ThrowStatementShadow extends BoaShadowType  {
    /**
    ...
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "THROW", new StatementKindProtoMap(), env);
    }
