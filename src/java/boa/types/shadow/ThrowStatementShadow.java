 ...
 * @author kaushin
 */
public class ThrowStatementShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link ThrowStatementShadow}.
     */
    public ThrowStatementShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type ThrowStatementShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "THROW", new boa.types.proto.enums.StatementKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Statement flattenMessage(final boa.types.Ast.Statement.ThrowStatement m) {
