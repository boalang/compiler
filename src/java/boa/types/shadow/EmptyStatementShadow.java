 ...
 * @author kaushin
 */
public class EmptyStatementShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link EmptyStatementShadow}.
     */
    public EmptyStatementShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type EmptyStatementShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "EMPTY", new boa.types.proto.enums.StatementKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Statement flattenMessage(final boa.types.Ast.Statement.EmptyStatement m) {
