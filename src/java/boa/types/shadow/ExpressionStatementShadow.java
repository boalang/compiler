 ...
 * @author kaushin
 */
public class ExpressionStatementShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link ExpressionStatementShadow}.
     */
    public ExpressionStatementShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type ExpressionStatementShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("StatementKind", "EXPR", new boa.types.proto.enums.StatementKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Statement flattenMessage(final boa.types.Ast.Statement.ExpressionStatement m) {
        final boa.types.Ast.Statement.Builder b = boa.types.Ast.Statement.newBuilder();
        b.setKind(boa.types.Ast.Statement.StatementKind.EXPR);
