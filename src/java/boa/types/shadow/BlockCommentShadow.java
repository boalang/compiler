 ...
 * @author kaushin
 */
public class BlockCommentShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link BlockCommentShadow}.
     */
    public BlockCommentShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type BlockCommentShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("CommentKind", "BLOCK", new boa.types.proto.enums.CommentKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Comment flattenMessage(final boa.types.Ast.Comment.BlockComment m) {
