 ...
 * @author kaushin
 */
public class MarkerAnnotationShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link MarkerAnnotationShadow}.
     */
    public MarkerAnnotationShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type MarkerAnnotationShadow");
    }
    ...
    public IfStatement getManytoOne(final SymbolTable env, final Block b) {
        return getManytoOne(env, b, "ismarkerannot", new boa.types.proto.ModifierProtoTuple());
    }
     ...
     */
    public boa.types.Ast.Modifier flattenMessage(final boa.types.Ast.Modifier.Annotation.MarkerAnnotation m) {
