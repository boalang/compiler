 ...
 * @author kaushin
 */
public class CastExpressionShadow extends boa.types.BoaShadowType  {
    /**
     * Construct a {@link CastExpressionShadow}.
     */
    public CastExpressionShadow() {
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type CastExpressionShadow");
    }

    /** {@inheritDoc} */
    @Override
    public Expression getKindExpression(final SymbolTable env) {
        return getKindExpression("ExpressionKind", "CAST", new boa.types.proto.enums.ExpressionKindProtoMap(), env);
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.CastExpression m) {
