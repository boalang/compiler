 ...
 * @author kaushin
 */
public class NullLiteralShadow extends boa.types.BoaShadowType  {
    /**
    ...
    public Node lookupCodegen(final String name, final Factor fact, final SymbolTable env) {
        ...
        throw new RuntimeException("invalid shadow field '" + name + "' in shadow type NullLiteralShadow");
    }
    ...
    public IfStatement getManytoOne(final SymbolTable env, final Block b) {
        return getManytoOne(env, b, "isnulllit", new boa.types.proto.ExpressionProtoTuple());
    }
     ...
     */
    public boa.types.Ast.Expression flattenMessage(final boa.types.Ast.Expression.NullLiteral m) {
