...
/**
 * A {@link BoaType} representing ML model of Lsa with attached types.
 * 
 * @author ankuraga
 */
public class BoaLsa extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaLsa Constructor.
	 * 
	 */
	public BoaLsa(){
	}
	 ...
	 *
	 */
	public BoaLsa(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaLsa";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaLsa" + "/" + this.t;
	}
}