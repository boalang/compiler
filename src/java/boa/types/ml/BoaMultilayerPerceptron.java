...
/**
 * A {@link BoaType} representing ML model of MultilayerPerceptron with attached types.
 * 
 * @author ankuraga
 */
public class BoaMultilayerPerceptron extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaMultilayerPerceptron Constructor.
	 * 
	 */
	public BoaMultilayerPerceptron(){
	}
	
	/**
	 * Construct a BoaMultilayerPerceptron.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaMultilayerPerceptron(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaMultilayerPerceptron(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaMultilayerPerceptron";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaMultilayerPerceptron" + "/" + this.t;
	}
}