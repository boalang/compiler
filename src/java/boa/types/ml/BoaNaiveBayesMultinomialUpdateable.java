...
/**
 * A {@link BoaType} representing ML model of NaiveBayesMultinomialUpdateable with attached types.
 * 
 * @author ankuraga
 */
public class BoaNaiveBayesMultinomialUpdateable extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaNaiveBayesMultinomialUpdateable Constructor.
	 * 
	 */
	public BoaNaiveBayesMultinomialUpdateable(){
	}
	
	/**
	 * Construct a BoaNaiveBayesMultinomialUpdateable.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaNaiveBayesMultinomialUpdateable(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaNaiveBayesMultinomialUpdateable(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toString() {
		return "boa.types.ml.BoaNaiveBayesMultinomialUpdateable" + "/" + this.t;
	}
}