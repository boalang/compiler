...
/**
 * A {@link BoaType} representing ML model of LogisticRegression with attached types.
 * 
 * @author ankuraga
 */
public class BoaLogisticRegression extends BoaModel{
	 ...
	 * 
	 */
	public BoaLogisticRegression(){
	}
	
	/**
	 * Construct a BoaLogisticRegression.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaLogisticRegression(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaLogisticRegression(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaLogisticRegression";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaLogisticRegression" + "/" + this.t;
	}
}