...
/**
 * A {@link BoaType} representing ML model of MultiClassClassifier with attached types.
 * 
 * @author ankuraga
 */
public class BoaMultiClassClassifier extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaMultiClassClassifier Constructor.
	 * 
	 */
	public BoaMultiClassClassifier(){
	}
	
	/**
	 * Construct a BoaMultiClassClassifier.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaMultiClassClassifier(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaMultiClassClassifier(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaMultiClassClassifier";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaMultiClassClassifier" + "/" + this.t;
	}
}