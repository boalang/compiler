...
/**
 * A {@link BoaType} representing ML model of HoeffdingTree with attached types.
 * 
 * @author ankuraga
 */
public class BoaHoeffdingTree extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaHoeffdingTree Constructor.
	 * 
	 */
	public BoaHoeffdingTree(){
	}
	
	/**
	 * Construct a BoaHoeffdingTree.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaHoeffdingTree(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaHoeffdingTree(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaHoeffdingTree";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaHoeffdingTree" + "/" + this.t;
	}
}