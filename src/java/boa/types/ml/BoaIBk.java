...
/**
 * A {@link BoaType} representing ML model of IBk with attached types.
 * 
 * @author ankuraga
 */
public class BoaIBk extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaIBk Constructor.
	 * 
	 */
	public BoaIBk(){
	}
	 ...
	 *
	 */
	public BoaIBk(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaIBk";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaIBk" + "/" + this.t;
	}
}