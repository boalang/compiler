...
/**
 * A {@link BoaType} representing ML model of Apriori with attached types.
 * 
 * @author ankuraga
 */
public class BoaApriori extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaApriori Constructor.
	 * 
	 */
	public BoaApriori(){
	}
	 ...
	 *
	 */
	public BoaApriori(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaApriori";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaApriori" + "/" + this.t;
	}
}