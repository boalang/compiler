...
/**
 * A {@link BoaType} representing ML model of SMO with attached types.
 * 
 * @author ankuraga
 */
public class BoaSMO extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaSMO Constructor.
	 * 
	 */
	public BoaSMO(){
	}
	 ...
	 *
	 */
	public BoaSMO(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaSMO";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaSMO" + "/" + this.t;
	}
}