...
/**
 * A {@link BoaType} representing ML model of PrincipalComponents with attached types.
 * 
 * @author ankuraga
 */
public class BoaPrincipalComponents extends BoaModel{
	private Classifier clr;
	private BoaType t;
	private Object o;
	
	/**
	 * Default BoaPrincipalComponents Constructor.
	 * 
	 */
	public BoaPrincipalComponents(){
	}
	
	/**
	 * Construct a BoaPrincipalComponents.
	 * 
	 * @param t
	 *            A {@link BoaType} containing the types attached with this model
	 *
	 */
	public BoaPrincipalComponents(BoaType t){
		this.t = t;
	}
	 ...
	 *
	 */
	public BoaPrincipalComponents(Classifier clr, Object o){
		this.clr = clr;
		this.o = o;
	}
	...
	public String toJavaType() {
		return "boa.types.ml.BoaPrincipalComponents";
	}
	
	/** {@inheritDoc} */
	@Override
	public String toString() {
		return "boa.types.ml.BoaPrincipalComponents" + "/" + this.t;
	}
}