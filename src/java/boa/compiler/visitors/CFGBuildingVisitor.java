...
public class CFGBuildingVisitor extends AbstractVisitorNoArg {
	...
	public final void dfsForward(final Node node, java.util.HashMap<Integer,String> nodeVisitStatus) {
		System.out.println(node);
		System.out.println("\t"+node.successors);
		nodeVisitStatus.put(node.id,"visited");
		for (Node succ : node.successors) {
		    if (nodeVisitStatus.get(succ.id).equals("unvisited")) {
