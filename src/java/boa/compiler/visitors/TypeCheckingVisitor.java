        ...
        if (n.hasType()) {
            ...
            if (n.getType() instanceof OutputType) {
                ...
                if (model != null) {
                    ...
                    } else if (model instanceof BoaAdditiveRegression) {
                    ...
                    } else if (model instanceof BoaApriori) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaAttributeSelectedClassifier) {
                    ...
                    } else if (model instanceof BoaBagging) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaBayesNetGenerator) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaBayesNet) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaClassificationViaRegression) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaCVParameterSelection) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaDecisionStump) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaDecisionTable) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaFilteredClassifier) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaGaussianProcesses) {
                    ...
                    } else if (model instanceof BoaHoeffdingTree) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaIBk) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaInputMappedClassifier) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaIterativeClassifierOptimizer) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaJ48) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaJRip) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaKStar) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaLinearRegression) {
                    ...
                    } else if (model instanceof BoaLMT) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaLogisticRegression) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaLogitBoost) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaLsa) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaLWL) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaMultiClassClassifier) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaMultiClassClassifierUpdateable) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaMultilayerPerceptron) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaMultiScheme) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaNaiveBayes) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaNaiveBayesMultinomial) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaNaiveBayesMultinomialUpdateable) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaOneR) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaPART) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum))
                    ...
                    } else if (model instanceof BoaPrincipalComponents) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaRandomForest) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat))
                    ...
                    } else if (model instanceof BoaVote) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
                    ...
                    } else if (model instanceof BoaZeroR) {
                        if (!(types.get(types.size() - 1) instanceof BoaEnum || types.get(types.size() - 1) instanceof BoaInt
                                || types.get(types.size() - 1) instanceof BoaFloat || types.get(types.size() - 1) instanceof BoaTime))
