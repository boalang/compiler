 ...
 * @author hungc
 */
public class VariableCountingTransformer extends AbstractVisitorNoArgNoRet {
	protected final String visitArgName = "_n";
	protected static Integer counter = 0;
	protected static HashMap<String, String> newName = new HashMap<String, String>();
	...
	public void visit(VarDeclStatement n) {
		...
		if (n.getId().getToken().equals(oldVisitArgName))
			...
			newId = oldId + Integer.toString(counter);
