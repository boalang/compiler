...
public class SymbolTable {
	...
	public SymbolTable(final List<URL> libs) throws IOException {
		...
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new IssueKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new ChangeKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new CommentKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new ExpressionKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new FileKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new ModifierKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new RepositoryKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new StatementKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new TypeKindProtoMap() }, "${0}.name()"));
		this.setFunction("string", new BoaFunction(new BoaString(), new BoaType[] { new VisibilityProtoMap() }, "${0}.name()"));
