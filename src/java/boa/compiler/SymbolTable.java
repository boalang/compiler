...
public class SymbolTable {
	...
	static {
		...
		final BoaProtoMap[] dslMapTypes = {
			...
			new CDGNodeTypeProtoMap(),
			new CDGEdgeLabelProtoMap(),
			new DDGNodeTypeProtoMap(),
			new DDGEdgeLabelProtoMap(),
			new PDGNodeTypeProtoMap(),
			new PDGEdgeTypeProtoMap(),
			new PDGEdgeLabelProtoMap(),
			new TreeNodeTypeProtoMap(),
		...
		globalFunctions.addFunction("getcrypthash", new BoaFunction(new BoaString(), new BoaType[] { new PDGSlicerProtoTuple(), new BoaString() }, "${0}.getCryptHash(${1})"));
