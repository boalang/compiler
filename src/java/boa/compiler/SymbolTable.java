...
public class SymbolTable {
	...
	static {
		...
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new AttachmentProtoTuple() }, "${0}.hashCode()"));
		...
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new ForgeKindProtoMap() }, "${0}.hashCode()"));
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new IssueProtoTuple() }, "${0}.hashCode()"));
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new IssueCommentProtoTuple() }, "${0}.hashCode()"));
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new IssueKindProtoMap() }, "${0}.hashCode()"));
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new IssueRepositoryProtoTuple() }, "${0}.hashCode()"));
		globalFunctions.addFunction("int", new BoaFunction(new BoaInt(), new BoaType[] { new IssuesRootProtoTuple() }, "${0}.hashCode()"));
