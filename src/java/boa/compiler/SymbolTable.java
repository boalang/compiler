...
public class SymbolTable {
	...
	public static void resetTypeMap() {
		...
		types.put("ensemble", new BoaEnsemble());
	...
	private static void importLibs(final List<URL> urls) throws IOException {
		...
		final Class<?>[] builtinAggs = {
			...
			boa.aggregators.ml.weka.LinearRegressionAggregator.class,
			boa.aggregators.ml.weka.AdaBoostM1Aggregator.class,
			boa.aggregators.ml.weka.ZeroRAggregator.class,
			boa.aggregators.ml.weka.VoteAggregator.class,
			boa.aggregators.ml.weka.SMOAggregator.class,
			boa.aggregators.ml.weka.SimpleKMeansAggregator.class,
			boa.aggregators.ml.weka.RandomForestAggregator.class,
			boa.aggregators.ml.weka.AdditiveRegressionAggregator.class,
			boa.aggregators.ml.weka.AttributeSelectedClassifierAggregator.class,
			boa.aggregators.ml.weka.PARTAggregator.class,
			boa.aggregators.ml.weka.OneRAggregator.class,
			boa.aggregators.ml.weka.NaiveBayesUpdateableAggregator.class,
			boa.aggregators.ml.weka.NaiveBayesAggregator.class,
			boa.aggregators.ml.weka.MultiSchemeAggregator.class,
			boa.aggregators.ml.weka.MultiClassClassifierAggregator.class,
			boa.aggregators.ml.weka.MultilayerPerceptronAggregator.class,
			boa.aggregators.ml.weka.BaggingAggregator.class,
			boa.aggregators.ml.weka.BayesNetAggregator.class,
			boa.aggregators.ml.weka.ClassificationViaRegressionAggregator.class,
			boa.aggregators.ml.weka.LWLAggregator.class,
			boa.aggregators.ml.weka.LogitBoostAggregator.class,
			boa.aggregators.ml.weka.LMTAggregator.class,
			boa.aggregators.ml.weka.LogisticRegressionAggregator.class,
			boa.aggregators.ml.weka.J48Aggregator.class,
			boa.aggregators.ml.weka.KStarAggregator.class,
			boa.aggregators.ml.weka.JRipAggregator.class,
			boa.aggregators.ml.weka.CVParameterSelectionAggregator.class,
			boa.aggregators.ml.weka.DecisionStumpAggregator.class,
			boa.aggregators.ml.weka.DecisionTableAggregator.class,
			boa.aggregators.ml.weka.FilteredClassifierAggregator.class,
			boa.aggregators.ml.weka.GaussianProcessesAggregator.class,
			boa.aggregators.ml.weka.InputMappedClassifierAggregator.class,
//			boa.aggregators.ml.Word2VectorAggregator.class,
//			boa.aggregators.ml.Sequence2VectorAggregator.class,
			boa.aggregators.ml.weka.AprioriAggregator.class,
			boa.aggregators.ml.weka.EvaluationAggregator.class
		};
