...
public class TestQ16 extends QueryTest {
	...
	@Test
	public void testQ16() throws MissingObjectException, IncorrectObjectTypeException, IOException {
		int methods = 0;
		int methodsMax = 0;
		...
		expected += "NonVoidMethodsMax[] = " + projectId + ", " + (double) methodsMax 
				+ "\nNonVoidMethodsMean[] = " + mean
				+ "\nNonVoidMethodsMin[] = " + projectId + ", " + (double) methodsMin 
				+ "\nNonVoidMethodsTotal[] = " + methods + "\n";
		queryTest("test/known-good/q16.boa", expected);
	}
