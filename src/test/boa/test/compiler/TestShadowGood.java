...
public class TestShadowGood extends BaseTest {
	final private static String rootDir = "test/shadow/";
	...
	public TestShadowGood(final String fileName, final String ignored) {
