...
public class TestTypecheckGood extends BaseTest {
	...
	public TestTypecheckGood(final String fileName, final String ignored) {
		this.fileName = fileName;
	}

	// test a bunch of known good files
	@Test
	public void testTypecheckGood() throws IOException {
