...
public class TestTypecheckBad extends BaseTest {
	...
	public static Collection<Object[]> literals() {
		return Arrays.asList(new Object[][] {
			...
			{ "bad-views22.boa", "types 'table[year:int][projectID:string][fileName:string] of temp:int' and 'int' do not support '>>' operator" },
			{ "bad-views23.boa", "types 'tuple [int, string, string, int]' and 'int' do not support '>>' operator" },
			{ "bad-views24.boa", "type 'table[year:int][projectID:string][fileName:string] of temp:int' does not support the '+' operator" },
