...
public class TestTypecheckBad extends BaseTest {
	...
	public static Collection<Object[]> literals() {
		return Arrays.asList(new Object[][] {
			...
			{ "bad-views10.boa", "invalid index type 'int' for indexing into 'table[count:string][year:string] of happy:int'" },
			{ "bad-views11.boa", "table column out of bounds" },
			{ "bad-views12.boa", "invalid index type 'string' for indexing into 'table[count:string][year:string] of happy:int'" },
