...
public class TestReduce {
	...
	public static Collection<String[]> expressions() {
		return Arrays.asList(new String[][] {
			...
			{ "5.0 + x + 1", "6.0 + x" },
			{ "5.0 - x - 1", "4.0 + -x" }, // FIXME should be "4.0 - x"
			{ "1 - x - 5", "-4 + -x" }, // FIXME should be "-4 - x"
			{ "5.0 * x * 1", "5.0 * x" },
			{ "5.0 / x / 5", "1.0 / x" },

			{ "5.0 + 1 + x", "6.0 + x" },
			{ "5.0 - 1 - x", "4.0 + -x" }, // FIXME should be "4.0 - x"
			{ " 1 - 5 - x", "-4 + -x" }, // FIXME should be "-4 - x"
			{ "5.0 * 1 * x", "5.0 * x" },
			{ "5.0 / 5 / x", "1.0 / x" },
			...
			{ "-2 / (-3 + -5) * -3", "0" },
			{ "-2 / (-3.0 + -5) * -3", "-0.75" },
			{ "5.0 + 3.5 - 2 * a.length", "8.5 + -2 * a.length" }, // FIXME should be "8.5 - 2 * a.length"
			...
			{ "x - 3 * y - y", "x + -4 * y"}, // FIXME should be "x - 4 * y"
			{ "3 * y - x - y", "-x + 2 * y"},
			{ "3 * y - y - x", "-x + 2 * y"},
