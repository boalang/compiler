...
public class TestReduce {
	...
	public static Collection<String[]> expressions() {
		return Arrays.asList(new String[][] {
			...
			{ "x + 5.0 + 1", "6.0 + x" },
			{ "-x + 5.0 - 1", "5.0 + -x - 1" }, // FIXME should be "4.0 - x"
			{ "-x + 1 - 5", "1 + -x - 5" }, // FIXME should be "-4 - x"
			{ "x * 5.0 * 1", "5.0 * x" },
