...
import static boa.functions.BoaGraphIntrinsics.getddg;
import static boa.functions.BoaGraphIntrinsics.ddgToDot;
...
public class TestDdg {
	final private static File srcRootDir = new File("test/ddg/src");
	final private static File dotRootDir = new File("test/ddg/dot");
	...
	public TestDdg(final String src, final String dot) throws IOException {
