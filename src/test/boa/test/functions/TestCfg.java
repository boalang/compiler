...
import static boa.functions.BoaGraphIntrinsics.getcfg;
...
public class TestCfg {
	final private static File srcRootDir = new File("test/cfg/src");
	final private static File dotRootDir = new File("test/cfg/dot");
	...
	public TestCfg(final String src, final String dot) throws IOException {
