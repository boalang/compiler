...
public class TestCodeGeneratingVisitor {
	...
	public static void init() throws IOException {
		...
		TestCodeGeneratingVisitor.compiler = new CharSequenceCompiler<BoaRunner>(null, null);
		...
		TestCodeGeneratingVisitor.stg = StringTemplateGroup.loadGroup("BoaJavaHadoop");
	}
	...
	public void testCodeGeneratingVisitorHello() throws IOException, ParseException, ClassCastException, InstantiationException, IllegalAccessException,
		...
		TestCodeGeneratingVisitor.typeChecker.visit(BoaParser.Start(), st);
		BoaParser.ReInit(new StringReader(source));
		final String src = codeGenerator.visit(BoaParser.Start(), st);

		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.Hello", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		...
		mapReduceDriver.setMapper(boaRunner.getMapper());
		// TODO: add the combiner when MAPREDUCE-797 is integrated
		mapReduceDriver.setReducer(boaRunner.getReducer());
	...
	public void testCodeGeneratingVisitorSimple() throws IOException, ParseException, ClassCastException, InstantiationException, IllegalAccessException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.Simple", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorSimpleCompound() throws IOException, ParseException, ClassCastException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.SimpleCompound", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorQuickExample() throws IOException, ParseException, ClassCastException, InstantiationException, IllegalAccessException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.QuickExample", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorRealWordCount() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.RealWordCount", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorWordStats() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.WordStats", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorFilteredMeanValue() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.FilteredMeanValue", src, null, new Class<?>[] { BoaRunner.class })
					.newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
	...
	public void testCodeGeneratingVisitorStringConversion() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.StringConversion", src, null, new Class<?>[] { BoaRunner.class })
					.newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
	...
	public void testCodeGeneratingVisitorValueQuartiles() throws IOException, ParseException, ClassCastException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.ValueQuartiles", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorBigUglyWhen() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.BigUglyWhen", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorMaps() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.Maps", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorUppercaseMap() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.UppercaseMap", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorTimeParser() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.TimeParser", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorTopReferers() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.TopReferers", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
	...
	public void testCodeGeneratingVisitorRegex() throws IOException, ParseException, CharSequenceCompilerException, InstantiationException,
		...
		BoaRunner boaRunner = null;
		try {
			boaRunner = TestCodeGeneratingVisitor.compiler.compile("boa.Regex", src, null, new Class<?>[] { BoaRunner.class }).newInstance();
		} catch (final CharSequenceCompilerException e) {
			for (final Diagnostic<? extends JavaFileObject> d : e.getDiagnostics().getDiagnostics())
				System.err.println(d.toString());
			throw e;
